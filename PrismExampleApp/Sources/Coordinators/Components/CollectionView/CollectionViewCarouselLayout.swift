...
enum CollectionViewCarouselLayoutSpacingMode {
    case fixed(spacing: CGFloat)
    case overlap(visibleOffset: CGFloat)
}

enum CollectionViewCarouselLayoutAnimation {
...
class CollectionViewCarouselLayout: UICollectionViewFlowLayout {
    struct LayoutState {
        var size: CGSize
    ...
    var spacingMode = CollectionViewCarouselLayoutSpacingMode.fixed(spacing: 0)
    var animationMode = CollectionViewCarouselLayoutAnimation.scale(sideItemScale: 1.0, sideItemAlpha: 1.0, sideItemShift: 0.0)
